            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, hashManager.hashText(user.password)];
                    case 1:
                        hashPassword = _a.sent();
                        userDatabase = new UserDatabase_1.UserDatabase();
                        return [4, userDatabase.createUser(id, user.email, user.name, hashPassword, user.role)];
                    case 2:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userDatabase = new UserDatabase_1.UserDatabase();
                        return [4, userDatabase.getUserByEmail(user.email)];
                    case 1:
                        userFromDB = _a.sent();
                        hashManager = new HashManager_1.HashManager();
                        return [4, hashManager.comparePlainTextToHashedPassword(user.password, userFromDB.getPassword())];
                    case 2:
                        hashCompare = _a.sent();
                        authenticator = new Authenticator_1.Authenticator();
